...
import { passwordUpdate,toggleMessagePopup } from "../../utils/profileAction";
const Settings = ({ newMessagePopup }) => {
  ...
  return (
    <>
      {success && (
        <>
          <Message icon="check circle" header="Updated Successfully" color=" green" />
          <Divider hidden />
        </>
      )}
