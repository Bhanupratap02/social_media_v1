...
const handleChange = e => {
  ...
  // you can also create handlechange function 
  // for media input
...
const [showSocilalinks,setShowSocilaLinks] = useState(false)
    ...
    <>
      ...
      >
        ...
        <Segment>
          ...
          <CommonInputs
            user={user}
            showSocilalinks={showSocilalinks}
            setShowSocilaLinks={setShowSocilaLinks}
            handleChange={handleChange}
          />
